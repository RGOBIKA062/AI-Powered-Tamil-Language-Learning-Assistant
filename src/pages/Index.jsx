...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      icon: BookOpen,
      title: "Lessons",
      description: "Structured Tamil lessons for all levels",
    ...
    },
    {
      ...
      description: "Expand your Tamil vocabulary interactively",
    ...
    },
    {
      ...
      description: "Practice with new challenges every day",
    ...
    {
      icon: Globe,
      title: "Tamil Dialect Mode",
      description: "Explore regional dialects and examples",
  ...
  link: "/dialect"
    ...
    },
    {
      ...
      description: "Learn about Tamil culture and traditions",
    ...
    },
    {
      icon: CheckCircle,
      title: "Quizzes & Games",
      description: "Test your skills with fun activities",
    ...
    },
    {
      icon: Zap,
      title: "AI Tutor",
      description: "Get instant help and feedback from AI",
